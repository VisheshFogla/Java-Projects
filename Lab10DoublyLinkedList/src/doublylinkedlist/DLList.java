    ...
    public class DLList<E> {
        ...
        public Iterator<E> iterator() {
            return new DLListIterator<E>(this.head);
        }
    
    
        public Iterator<E> reverseIterator() {
            return new RDLListIterator<E>(this.tail);
        }
        ...
        private class DLListIterator<E> implements Iterator<E> {
            ...
            public DLListIterator(Node<E> head) {
            ...
            public void remove() {
                ...
                if (currentNode.data == null || !isNextCalled) {
        ...
        private class RDLListIterator<E> implements Iterator<E> {
             ...
             */
            @SuppressWarnings("unused")
            public RDLListIterator(Node<E> tail) {
            ...
            public boolean hasNext() {
                ...
                return currentNode.previous.data != null;
            }
            ...
            @Override
            public E next() {
                if (currentNode.previous().data == null) {
                    throw new NoSuchElementException();
                }
    
                E data = currentNode.previous().getData();
